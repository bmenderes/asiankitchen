...
function listen(e){
  ...
  if(e.target.innerHTML == 'All'){
    ...
    mapMenu = menu.filter(item => item.category == "Korea");
    allMenu()
  }
  else if(e.target.innerHTML == 'China'){
    mapMenu = menu.filter(item => item.category == "China");
    allMenu()
  }
  else if(e.target.innerHTML == 'Japan'){
    mapMenu = menu.filter(item => item.category == "Japan");
    allMenu()
  }    
}
